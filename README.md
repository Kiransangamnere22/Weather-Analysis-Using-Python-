...

{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "data=pd.read_csv(\"C:/Users/Asus/Downloads/1. Weather Data.csv\")"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "* we have total 8784 Rows and 8 columne"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "* we see that in the data we have (4) Float, (2) int and (2) object columns."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# checking the unique value by each column\n",
    "\n",
    "data['Weather'].unique()"
   ]
  },
  {
   ...
   "source": [
    "# checking the unique values with their count ( it apply only for single column)\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    "# checking no.count ( it shows the no.null value in columns)\n",
    "\n",
    "data.count()\n",
    "\n"
   ]
  },
  {
   ...
   "source": [
    "# or simplye we check null value\n",
    "\n",
    "data.isnull().sum()      # no null value in tha dataset"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "\n",
    "data.info()\n",
    "# in the data we have 2(object),4(float) and 2(int) columns"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# checking the value of mean,sd,min,max for the numerical columns\n",
    "\n",
    "data.describe()"
   ]
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Q) 1.Find all the Unique values in \"Wind speed\" column."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Q) 2. Find the number of times when the \"Weatheris exactly clear\""
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#### we see that \"1326\" times weather is exactly \"Clear\""
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#### 474 times \"Wind speed was exactly 4 km/h\"."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#### we see that \"474\" times Wind_speed is \"4\"Km/h"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "## Q) 4. Find out all null value in dataset"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Q) 5. Rename the column name \"Weather\"  to \"Weather_condtion\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "1  1/1/2012 1:00    -1.8              -3.7         87                4   \n",
       "\n",
       "   Visibility_km  Press_kPa Weather Condtion  \n",
       "0            8.0     101.24              Fog  \n",
       "1            8.0     101.24              Fog  "
      ]
     },
   ...
   "source": [
    "data.rename(columns= {'Weather':\"Weather Condtion\"},inplace=True)  \n",
    "data.head(2)"
   ]
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Q) 6. What is the mean of \" Visibility'' column "
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Q) 7. What is Standard Deviation of \"Presure\" coumn in dataset?"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# if ther is space between Columns name in data than we used\n",
    "\n",
    "data['Rel Hum_%'].var()"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    "data[data['Weather Condtion'] == \"Snow\"]"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "#### We see that \"390\" times Snow was Recored."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#### \"308\" instances when Wind speed above 24 and visibility is 25"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "## Q) 11.Find all the records where Weather condtion is Fog. "
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "data[data['Weather Condtion']== 'Fog']"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "#### \"150\" records when Weather condtion is \"Fog\" "
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "## Q) 12.Find all instances when \"Weather is Clear\" or \"Visibility\" is above 40."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "data[(data['Weather Condtion'] == 'Clear') | (data['Visibility_km'] > 40)]   # or == (|)"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "## Q) 13.Find all instances when \"Weather is Clear\" and \"Relative Humidity\" is above 50."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "data[(data['Weather Condtion'] == 'Clear') & (data['Rel Hum_%'] > 50)]"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "metadata": {},
   "source": [
    "#### We see that \"1070\" instances when \"Weather is Clear\" and \"Relative Humidity\" is above 50"
   ]
  },
  {
   "cell_type": "code",
